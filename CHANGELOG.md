...
## [4.7.0] - 2026-02-23 - "Jules: Strategic Partner & Inspector"

> Added the Jules persona skill for strategic code review and security auditing.

### Added

- **New Skill**: `jules-inspector` – Strategic Partner & Inspector General persona for code review and security audits.
- **Fix**: Restored functionality for Piata AI Ad Processing and Dating App Verification.
- **Tools**: `ssh_manager.py` (local workflow utility, not committed).
## [4.7.0] - 2026-02-23 - "Jules: Strategic Partner & Inspector"
...
- **New Skill**:  – Strategic Partner & Inspector General persona for code review and security audits.
- **Fix**: Restored functionality for Piata AI Ad Processing and Dating App Verification.
